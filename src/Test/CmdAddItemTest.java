...
class CmdAddItemTest {
	...
	void testCmdAddItem_12() {
	    ...
	    String cmdLine = "startNewDay|15-Nov-2020";
	    String [] cmdParts = cmdLine.split("\\|");
	    (new CmdSetDate()).execute(cmdParts);
	    (new CmdDeliverExpiredItem()).execute(cmdParts);
	    
	    String cmdLine1 = "addItem|1|38-Nov-2020";
	    String [] cmdParts1 = cmdLine1.split("\\|");
	    (new CmdAddItem()).execute(cmdParts1);
	...
	void testCmdAddItem_13() {
	    ...
	    String cmdLine1 = "addItem|1|k-Nov-2020";
	    String [] cmdParts1 = cmdLine1.split("\\|");
	    (new CmdAddItem()).execute(cmdParts1);
	    
	    String msg = "wrong format of the day";
	    assertEquals("Wrong Input Format!", outContent.toString().trim().substring(outContent.toString().trim().lastIndexOf('\n')+1), msg);
	}
	...
	void testCmdAddItem_14() {
	    ...
	    String cmdLine1 = "addItem|1|29-Feb-2021";
	    String [] cmdParts1 = cmdLine1.split("\\|");
	    (new CmdAddItem()).execute(cmdParts1);
	...
	void testCmdAddItem_15() {
	    ...
	    String cmdLine1 = "addItem|1|29-Feb";
	    String [] cmdParts1 = cmdLine1.split("\\|");
	    (new CmdAddItem()).execute(cmdParts1);
	...
	void testCmdAddItem_16() {
	    ...
	    String cmdLine = "startNewDay|1-Dec-2020";
	    String [] cmdParts = cmdLine.split("\\|");
	    (new CmdSetDate()).execute(cmdParts);
	    (new CmdDeliverExpiredItem()).execute(cmdParts);
	    
	    String cmdLine2 = "addItem|5|24-Dec-2020";
	    String [] cmdParts2 = cmdLine2.split("\\|");
	    (new CmdAddItem()).execute(cmdParts2);
	    ...
	    String msg = "Checking redo command for CmdAddItem when there is no addition of items between undo and redo";
	    assertEquals("Nothing to redo.", outContent.toString().trim().substring(outContent.toString().trim().lastIndexOf('\n')+1), msg);
	}
}
